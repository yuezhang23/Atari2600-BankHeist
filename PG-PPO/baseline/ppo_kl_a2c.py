...
class PPOBuffer:
    ...
    def store(self, obs, act, rew, val, logp):
        ...
        self.obs_buf[self.ptr] = obs.flatten().reshape(1, -1)
...
def ppo(actor_critic=MLPActorCritic, ac_kwargs=dict(), seed=0, 
    ...
    for epoch in range(epochs):
        for t in range(local_steps_per_epoch):
            ...
            a, v, logp = ac.step(torch.as_tensor(o, dtype=torch.float32), ep_ret)
            ...
            if terminal or epoch_ended:
                ...
                print("Epoch:", epoch, "Reward:", ep_ret) 
                o, _ = env.reset()
                ep_ret, ep_len = 0, 0
...
if __name__ == '__main__':
    ...
    parser.add_argument('--env', type=str, default='BankHeist-v4')
    ...
    ppo(actor_critic=MLPActorCritic,
