...
class Args:
    ...
    env_id: str = "BankHeist-v4"
    """the id of the environment"""
    total_timesteps: int = 8000000
    """total timesteps of the experiments"""
    learning_rate: float = 5e-5  # learning faster than 2.5e-4
    ...
    clip_coef: float = 0.1  # more exploration than 0.1
    """the surrogate clipping coefficient"""
    clip_vloss: bool = True
    """Toggles whether or not to use a clipped loss for the value function, as per the paper."""
    ent_coef: float = 0.01  # more exploration than 0.01
...
if __name__ == "__main__":
    ...
    # pass a different seed for each data parallelism worker
